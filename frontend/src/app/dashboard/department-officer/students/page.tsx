...
export default function DeptStudentsPage() {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ["dept-students", page, debouncedSearch, levelFilter],
    queryFn: () => deptOfficerService.listStudents({
      page,
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Students"
        description="Students enrolled in combinations that include your department (read-only)."
      />
      ...
      <Card className="p-4">
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            description={debouncedSearch || levelFilter ? "Try adjusting your filters." : "Students appear here once the School Exam Officer assigns them to a combination that includes your department."}
          />
        ) : (
