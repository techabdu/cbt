...
class StoreCourseRequest extends FormRequest
{
    ...
    /**
     * The department is resolved by the department.scope middleware, not supplied
     * by the client — pin it before validation so it can't be spoofed.
     */
    protected function prepareForValidation(): void
    {
        $this->merge(['department_id' => $this->attributes->get('department_id')]);
    }
